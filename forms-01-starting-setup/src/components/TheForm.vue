<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <input v-model.trim="userName" @blur="validateInput" id="user-name" name="user-name" type="text" />
      <p v-if="userNameValidity === 'invalid'">Please enter a valid username</p>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input v-model="userAge" ref="ageInput" id="age" name="age" type="number" />
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <div>
        <input v-model="how" id="how-video" value="video" name="how" type="radio" />
        <label for="how-video">Video Courses</label>
      </div>
      <div>
        <input v-model="how" id="how-blogs" value="blogs" name="how" type="radio" />
